...
var ErrKeyNotFound os.Error = os.NewError("Key not found")
...
*/
func NewGocask(directory string) (b *Gocask, err os.Error) {
...
*/
func (g *Gocask) openActiveFile() (file *os.File, err os.Error) {
...
*/
func (g *Gocask) Put(key string, value []byte) os.Error {
	if g.keydir == nil {
		return os.NewError("key dir is invalid")
	}

	if g.activeFile == nil {
		return os.NewError("Active file is not defined")
	}
...
*/
func (g *Gocask) Get(key string) (value []byte, err os.Error) {
...
*/
func (g *Gocask) populateKeyDir() os.Error {
